  ...
  return (
    <React.Fragment>
      <svg height="620" width="620" viewBox="0 0 620 620">
        ...
        <g filter= "drop-shadow(3px 5px 2px rgb(0 0 0 / 0.8))"
        ...
        <g filter= "drop-shadow(3px 5px 2px rgb(0 0 0 / 0.8))"
          ...
          className={
            props.currentMenu === "Work Experience" ? "active-weapon" : ""
          }
        >
          <path
        ...
        <g filter= "drop-shadow(3px 5px 2px rgb(0 0 0 / 0.8))"
          ...
          className={
            props.currentMenu === "Education Timeline" ? "active-weapon" : ""
          }
        >
          <path
        ...
        <g filter= "drop-shadow(3px 5px 2px rgb(0 0 0 / 0.8))"
          ...
          className={
            props.currentMenu === "Client Testimonials" ? "active-weapon" : ""
          }
        >
          <path
        ...
        <g filter= "drop-shadow(3px 5px 2px rgb(0 0 0 / 0.8))"
          ...
          className={
            props.currentMenu === "Libraries Used" ? "active-weapon" : ""
          }
        >
          <path
